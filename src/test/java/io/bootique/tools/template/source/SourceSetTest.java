...
public class SourceSetTest {
    ...
    public void testDefaultFilter() {
        ...
        Map<Path, Boolean> testData = Map.of(
                PATHS[0], true, 
                PATHS[1], true, 
                PATHS[2], true, 
                PATHS[3], true
    ...
    public void testOneIncludeFilter() {
        ...
        sourceSet.setIncludes(Set.of(PATHS[0]::equals));
    ...
    public void testOneExcludeFilter() {
        ...
        sourceSet.setExcludes(Set.of(filter.negate()));
    ...
    public void testCombinedIncludeFilter() {
        ...
        sourceSet.setIncludes(Set.of(PATHS[0]::equals, PATHS[2]::equals));
    ...
    public void testCombinedExcludeFilter() {
        ...
        sourceSet.setExcludes(Set.of(filter1.negate(), filter2.negate()));
