    ...
    public NewCommand() {
        super(CommandMetadata
                ...
                .addOption(OptionMetadata.builder("type")
                        .description("type of artifact to create, possible values: @|bold maven-project, gradle-project, module|@")
                        .valueRequired()
                        .build())
                .addOption(OptionMetadata.builder("name")
                        .description("name of artifact to create, format: [@|bold java-package.|@]@|bold project-name|@")
                        .valueRequired()
                        .build())
                .shortName('n')
        );
